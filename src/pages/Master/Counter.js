...
import { CopyAllOutlined, DeleteOutline, NoteAdd, Phone, WhatsApp } from "@mui/icons-material"
...
function Table({ itemsDetails, setPopupForm, setItemPopup, setDeletePopup, setCounterNotesPoup }) {
...
function NewUserForm({ onSave, popupInfo, routesData, paymentModes, counters, getCounter, setNotification }) {

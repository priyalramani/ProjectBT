																			...
																			items: prev?.items?.filter(a => a.item_uuid === item.item_uuid)?.length
																				? prev?.items?.map(a =>
																						a.item_uuid === item.item_uuid
																							? {
																									...
																									b:
																										+(a.b || 0) +
																										parseInt(((a?.p || 0) +  1) / +item.conversion),

																									p: ((a?.p || 0) +  1) % +item.conversion
																							  }
																							: a
																				  )
																				: prev?.items?.length
																				...
																				: filterItems
																						...
																						.map(a => ({
																							...a,
																							b:
																								+(a.b || 0) + parseInt(((a?.p || 0) +  1) / +item.conversion),
															...
															>
																<div className="menuItemDetails">
																	...
																	>
																		...
																		{item.stock?<h3 className={`item-price`}>Stock: {item?.stock || ""}</h3>:""}
																	</div>
																</div>
